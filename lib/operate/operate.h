...
inline uint32_t RadiusToServo1Speed(double r){return (uint32_t)(r-JOYCON_DEADZONE)/540;}
inline uint32_t RadiusToServo2Speed(double r){return (uint32_t)(r-JOYCON_DEADZONE)/540;}
